...
```
    ...
    precision=[0.49640288 0.33333333 0.504     ], recall=[0.70769231 0.27941176 0.33870968], f1=[0.58350951 0.304      0.40514469], accuracy=0.46
    rec:['stage1', 288, 517, '+:186,0:136,-:195', 0.26305609284332687, 0.30754352030947774, 0.3520309477756286, 0.4526112185686654, 0.4796905222437137, 0.4758220502901354, 0.4584139264990329, 0.44294003868471954, 0.45454545454545453, 0.4622823984526112]
    [*] predict with currank model
    ...
    [*] predict with lsvc model
    precision=[0.50314465 0.         0.45982143], recall=[0.60606061 0.         0.73571429], f1=[0.54982818 0.         0.56593407], accuracy=0.48
    [*] predict with lsvcl2 model
    precision=[0.5        0.29508197 0.43303571], recall=[0.14393939 0.32142857 0.69285714], f1=[0.22352941 0.30769231 0.53296703], accuracy=0.40
    [*] predict with rf model
    ...
    precision=[0.43426295 0.39393939 0.57      ], recall=[0.82575758 0.11607143 0.40714286], f1=[0.5691906  0.17931034 0.475     ], accuracy=0.47
    [*] predict with lrbias model
    ...
    precision=[0.44117647 0.38095238 0.47008547], recall=[0.68181818 0.21428571 0.39285714], f1=[0.53571429 0.27428571 0.42801556], accuracy=0.44
    rec:['stage2', 421, 384, '+:140,0:112,-:132', 0.2916666666666667, 0.2630208333333333, 0.3177083333333333, 0.484375, 0.4739583333333333, 0.4765625, 0.3958333333333333, 0.4661458333333333, 0.4739583333333333, 0.4401041666666667]
    [*] predict with currank model
    ...
    precision=[0.46456693 0.22222222 0.52459016], recall=[0.75641026 0.02247191 0.7032967 ], f1=[0.57560976 0.04081633 0.60093897], accuracy=0.48
    [*] predict with lsvcl2 model
    precision=[0.33333333 0.35828877 0.54      ], recall=[0.08974359 0.75280899 0.2967033 ], f1=[0.14141414 0.48550725 0.38297872], accuracy=0.39
    [*] predict with rf model
    precision=[0.40384615 0.52941176 0.52941176], recall=[0.80769231 0.1011236  0.49450549], f1=[0.53846154 0.16981132 0.51136364], accuracy=0.45
    [*] predict with lrbias model
    ...
    precision=[0.37333333 0.625      0.44047619], recall=[0.71794872 0.16853933 0.40659341], f1=[0.49122807 0.26548673 0.42285714], accuracy=0.42
    rec:['stage3', 547, 258, '+:91,0:89,-:78', 0.3449612403100775, 0.22868217054263565, 0.3333333333333333, 0.4844961240310077, 0.47674418604651164, 0.4844961240310077, 0.39147286821705424, 0.45348837209302323, 0.4728682170542636, 0.4186046511627907]
    [*] predict with currank model
    ...
    precision=[0.58333333 0.25       0.34677419], recall=[0.14893617 0.05660377 0.89583333], f1=[0.23728814 0.09230769 0.5       ], accuracy=0.36
    [*] predict with rf model
    precision=[0.45833333 0.5625     0.59090909], recall=[0.70212766 0.33962264 0.54166667], f1=[0.55462185 0.42352941 0.56521739], accuracy=0.52
    [*] predict with lrbias model
    ...
    precision=[0.48076923 0.425      0.51785714], recall=[0.53191489 0.32075472 0.60416667], f1=[0.50505051 0.3655914  0.55769231], accuracy=0.48
    rec:['stage4', 657, 148, '+:48,0:53,-:47', 0.3581081081081081, 0.20945945945945946, 0.34459459459459457, 0.5540540540540541, 0.5608108108108109, 0.5608108108108109, 0.3581081081081081, 0.5202702702702703, 0.5743243243243243, 0.4797297297297297]
    [*] predict with currank model
    ...
    precision=[0.58823529 0.48837209 0.6       ], recall=[0.4        0.72413793 0.46153846], f1=[0.47619048 0.58333333 0.52173913], accuracy=0.54
    [*] predict with lsvcl2 model
    precision=[0.46666667 0.66666667 0.42553191], recall=[0.56       0.06896552 0.76923077], f1=[0.50909091 0.125      0.54794521], accuracy=0.45
    [*] predict with rf model
    precision=[0.55555556 0.55555556 0.69230769], recall=[0.8        0.34482759 0.69230769], f1=[0.6557377  0.42553191 0.69230769], accuracy=0.60
    [*] predict with lrbias model
    ...
    precision=[0.56       0.52173913 0.5625    ], recall=[0.56       0.4137931  0.69230769], f1=[0.56       0.46153846 0.62068966], accuracy=0.55
    rec:['stage5', 725, 80, '+:26,0:29,-:25', 0.3625, 0.2, 0.325, 0.575, 0.5875, 0.5375, 0.45, 0.6, 0.575, 0.55]
    [*] predict with currank model
    ...
    precision=[0.72727273 0.31578947 0.25      ], recall=[0.57142857 0.46153846 0.18181818], f1=[0.64       0.375      0.21052632], accuracy=0.42
    [*] predict with rf model
    precision=[0.52380952 0.42857143 0.7       ], recall=[0.78571429 0.23076923 0.63636364], f1=[0.62857143 0.3        0.66666667], accuracy=0.55
    [*] predict with lrbias model
    ...
    precision=[0.625 0.375 0.5  ], recall=[0.71428571 0.23076923 0.63636364], f1=[0.66666667 0.28571429 0.56      ], accuracy=0.53
    rec:['stage6', 767, 38, '+:11,0:13,-:14', 0.34210526315789475, 0.23684210526315788, 0.2631578947368421, 0.5263157894736842, 0.5263157894736842, 0.5263157894736842, 0.42105263157894735, 0.5526315789473685, 0.5263157894736842, 0.5263157894736842]
    [*] predict with currank model
    ...
    precision=[0.58333333 0.         0.75      ], recall=[0.875 0.    0.75 ], f1=[0.7  0.   0.75], accuracy=0.62
    [*] predict with rf model
    ...
    precision=[0.6        0.25       0.42857143], recall=[0.375 0.25  0.75 ], f1=[0.46153846 0.25       0.54545455], accuracy=0.44
    rec:['stage7', 789, 16, '+:4,0:4,-:8', 0.25, 0.1875, 0.3125, 0.375, 0.375, 0.375, 0.625, 0.4375, 0.375, 0.4375]
