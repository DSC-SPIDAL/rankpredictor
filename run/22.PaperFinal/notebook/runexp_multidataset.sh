...
for test_event in ${testevents[*]}; do
    ...
    ./run_quicktest_slim.sh QuickTestOutput/weighted-noinlap-S0LTYP0T-nocate-c60-drank-pitmodel.ini --forecast_mode=shortterm --pitmodel_bias=0 --loopcnt=20 --year=${test_event} --test_event=${test_event} --suffix=debug
